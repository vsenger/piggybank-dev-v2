...
public class PbnkEbStack extends Stack {
    ...
    public PbnkEbStack(final Construct scope,
        ...
        ebApp = CfnApplication.Builder.create(this, "pbnk-eb-app")
                .applicationName("pbnk-eb-app")
                .build();

        var s3full = ManagedPolicy.fromManagedPolicyArn(this,
                "pbnk-s3-full",
                "arn:aws:iam::aws:policy/AmazonS3FullAccess");

        var instanceRole = Role.Builder.create(this, "pbnk-role")
                .assumedBy(ServicePrincipal.Builder.create("ec2.amazonaws.com").build())
                .managedPolicies(List.of(s3full))
                .build();
        ...
        appBucket = Bucket.Builder.create(this, "pbnk-app-bucket")
                .build();
    }
